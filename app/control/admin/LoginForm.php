...
class LoginForm extends TPage
{
    ...
    public function __construct($param)
    {
        ...
        $this->form->addFooterAction('🚛 Portal Motorista', new TAction([$this, 'onGoToPortal']), 'fa:truck blue');
    ...
    public static function onLogin($param)
    {
        ...
        try
        {
            ...
            if ($user)
            {
                ...
                {
                    AdiantiCoreApplication::gotoPage('CrmDashboard'); // reload
                    TSession::setValue('frontpage', 'CrmDashboard');
                }
            }
        }
        catch (Exception $e)
    ...
    public static function onGoToPortal()
    {
        TScript::create("window.location='portal-motorista/'");
    }
