<?php
/**
 * CaixaForm - FormulÃ¡rio de lanÃ§amento manual no caixa
 */
class CaixaForm extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        // ValidaÃ§Ãµes
        $data->addValidation('Data LanÃ§amento', new TRequiredValidator);
        ...
        $form_builder->setFormTitle('LanÃ§amento no Caixa');
        ...
        $form_builder->addFields([new TLabel('DescriÃ§Ã£o (*)', 'red')], [$descricao]);
        $form_builder->addFields([new TLabel('Valor R$ (*)', 'red')], [$valor], [new TLabel('Status')], [$status]);
        $form_builder->addFields([new TLabel('ObservaÃ§Ã£o')], [$observacao]);
        ...
        $panel = new TPanelGroup('Caixa Financeiro - LanÃ§amento');
    ...
    public function onSave($param)
    {
        try {
            ...
            TTransaction::close();
            new TMessage('info', 'LanÃ§amento salvo com sucesso!');
        } catch (Exception $e) {
