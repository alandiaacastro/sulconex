...
Localidade pais e data em que o transportador se responsabiliza para mercadoria '));
        ...
        $pdf->SetFont('Helvetica', '', 6);
        $pdf->Text(106, 211, iconv('UTF-8', 'ISO-8859-1//TRANSLIT', '18 instruccioner sobre formalidades de aduana / Instru��es sobre formalidades de alf�ndega'));
        $pdf->SetXY(106, 213);
        $pdf->SetFont('Helvetica', '', 8);
...
Nome e assinatura do remetente ou seu representante"));
     ...
     //   $nome_transportadora = $permisso->transportadora;
        $pdf->MultiCell(85, 4, iconv('UTF-8', 'ISO-8859-1//TRANSLIT', $permisso->dados_documentos), 0, 'L'); 
