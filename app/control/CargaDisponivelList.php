...
class CargaDisponivelList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $action_whats = new TDataGridAction([$this, 'onWhatsApp']);
        ...
        $this->datagrid->addQuickAction('WhatsApp', $action_whats, 'id', 'fab:whatsapp green');
        $this->datagrid->addQuickAction('Copiar', $action_copy, 'id', 'fa:copy orange');
        ...
        $action_whats->setDisplayCondition(function ($object) {
     ...
     */
    private static function buildCargaText($carga)
    {
        ...
        $frete = is_numeric($carga->valor_frete) ? 'R$ ' . number_format((float) $carga->valor_frete, 2, ',', '.') : 'A combinar';
