...
HTML;
    ...
    public function onReload($param = null)
    {
        try {
            ...
            // Cache de caixas para uso no transformer (evita N consultas)
            $conn = TTransaction::get();
            self::$caixaIndex = [];
            $ids = $conn->query("SELECT referencia_id FROM caixa WHERE referencia_tipo='fatura'")->fetchAll(\PDO::FETCH_COLUMN);
            foreach ($ids as $cid) {
