...
class SystemChangeLogView extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        $this->form->addFields( [new TLabel(_t('Table'))], [$tablename], [new TLabel('Login')], [$login] );
        $this->form->addFields( [new TLabel(_t('Session'))], [$session_id] );
        ...
        $oldvalue   = new TDataGridColumn('oldvalue',   'Onde se le', 'left');
        $newvalue   = new TDataGridColumn('newvalue',   'Leia-se', 'left');
