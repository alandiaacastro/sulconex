...
class MotoristasList extends TPage
{
    ...
    public function __construct($param)
    {
        ...
        $this->setActiveRecord('Motoristas'); // defines the active record
        ...
        try
        {
            ...
            $this->ui->setPageName('Listar Motoristas');
            $this->ui->enableForm();
            
            TTransaction::open('Principal');
            $this->ui->parseFile('app/forms/Principal/MotoristasList.xml');
            TTransaction::close();
    ...
    public function onExportPDF($param)
    {
        ...
        self::showInWindow(self::embedPDFObject($output), 'Listar Motoristas');
    }//end-of-onExportPDF()
