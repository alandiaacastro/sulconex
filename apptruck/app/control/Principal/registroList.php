...
class registroList extends TPage
{
    ...
    private static $form_name = 'form_registroList';
    ...
    public function __construct($param)
    {
        ...
        $this->setActiveRecord('registro'); // defines the active record
        ...
        try
        {
            ...
            $this->ui->setPageName('Listar registro');
            $this->ui->enableForm();
            
            TTransaction::open('Principal');
            $this->ui->parseFile('app/forms/Principal/registroList.xml');
            TTransaction::close();
    ...
    public function onExportPDF($param)
    {
        ...
        self::showInWindow(self::embedPDFObject($output), 'Listar registro');
    }//end-of-onExportPDF()
