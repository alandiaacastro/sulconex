 ...
 */
class MotoristasForm extends TPage
{
    private AdiantiXMLFormRender $ui;
    private TForm $form;
    private static $form_name = 'form_MotoristasForm';
    ...
    public function __construct($param)
    {
        ...
        try
        {
            ...
            $this->ui->setPageName('Formulário Motoristas');
            $this->ui->enableForm();
            
            TTransaction::open('Principal');
            $this->ui->parseFile('app/forms/Principal/MotoristasForm.xml');
            TTransaction::close();
    ...
    public function onSave($param)
    {
        ...
        if ($object)
        {
            AdiantiCoreApplication::loadPage('MotoristasList', 'onLoad');
        }
        return $object;
    }//end-of-onSave()
