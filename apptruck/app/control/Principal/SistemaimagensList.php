...
class SistemaimagensList extends TPage
{
    ...
    public function __construct($param)
    {
        ...
        $this->setActiveRecord('Sistemaimagens'); // defines the active record
        ...
        try
        {
            ...
            $this->ui->setPageName('Listar Sistema imagens');
            $this->ui->enableForm();
            
            TTransaction::open('Principal');
            $this->ui->parseFile('app/forms/Principal/SistemaimagensList.xml');
            TTransaction::close();
    ...
    public function onExportPDF($param)
    {
        ...
        self::showInWindow(self::embedPDFObject($output), 'Listar Sistema imagens');
    }//end-of-onExportPDF()
