...
class ClientesList extends TPage
{
    ...
    private static $form_name = 'form_ClientesList';
    ...
    public function __construct($param)
    {
        ...
        $this->setActiveRecord('Clientes'); // defines the active record
        ...
        try
        {
            ...
            $this->ui->setPageName('Clientes');
            $this->ui->enableForm();
            
            TTransaction::open('Principal');
            $this->ui->parseFile('app/forms/Principal/ClientesList.xml');
            TTransaction::close();
    ...
    public function onExportPDF($param)
    {
        ...
        self::showInWindow(self::embedPDFObject($output), 'Clientes');
    }//end-of-onExportPDF()
