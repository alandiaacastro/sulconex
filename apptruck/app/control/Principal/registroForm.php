...
class registroForm extends TPage
{
    ...
    private TForm $form;
    private static $form_name = 'form_registroForm';
    ...
    public function __construct($param)
    {
        ...
        try
        {
            ...
            $this->ui->setPageName('Formulário registro');
            $this->ui->enableForm();
            
            TTransaction::open('Principal');
            $this->ui->parseFile('app/forms/Principal/registroForm.xml');
            TTransaction::close();
    ...
    private function save($param)
    {
        try
        {
            ...
            $this->saveFile($object, $data, 'logo', 'files/images/logo/');
    ...
    public function onSave($param)
    {
        ...
        if ($object)
        {
            AdiantiCoreApplication::loadPage('registroList', 'onLoad');
        }
        return $object;
    }//end-of-onSave()
