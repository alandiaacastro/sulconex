...
/**
 * StatusCrtForm
 * Formulário Status Crt
 */
class StatusCrtForm extends TPage
{
    private AdiantiXMLFormRender $ui;
    private TForm $form;
    private static $form_name = 'form_StatusCrtForm';
    ...
    public function __construct($param)
    {
        ...
        try
        {
            ...
            $this->ui->setPageName('Formulário Status Crt');
            $this->ui->enableForm();
            
            TTransaction::open('Principal');
            $this->ui->parseFile('app/forms/Principal/StatusCrtForm.xml');
            TTransaction::close();
    ...
    public function onSave($param)
    {
        ...
        if ($object)
        {
            AdiantiCoreApplication::loadPage('StatusCrtList', 'onLoad');
        }
        return $object;
    }//end-of-onSave()
