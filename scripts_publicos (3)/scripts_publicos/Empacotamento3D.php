...
class Empacotamento3D
{
    ...
    public function generatePacking()
    {
        ...
        if ($this->sortByVolumeDesc) { 
            ...
            $this->addLog("INFO", "Empacotando na ordem de entrada das instâncias (carregamento ordenado).");
        }

        $totalItemsToPack = count($itemsToPack);
        $this->addLog("INFO", "Total de instâncias para empacotar: {$totalItemsToPack}.");
